...
llama_context::llama_context(
...

    {
        ...
        if (is_kvarn) {
            ...
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ENABLE_F32_DEQUANT_CACHE");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ATTN_ENABLE_BODY_F32_MIRROR");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ATTN_DISABLE_BODY_F32_MIRROR");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_DEBUG_CAPTURE_RAW_BODY_MIRROR");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_DEBUG_RAW_BODY_SCALAR_QT");
            ...
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ATTN_DISABLE_256D_SCALAR_QT");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ATTN_DISABLE_GQA_SCALAR_QT");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ATTN_DISABLE_Q1_GQA_SCALAR");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ATTN_REQUIRE_Q1_GQA_SCALAR");
            ...
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ATTN_FORCE_COMPACT_CAUSAL_MASK");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_DISABLE_ISWA_SINKTAIL_MHA");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ISWA_DEBUG_MATERIALIZE_MHA");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ISWA_DEBUG_DUAL_MHA_COMPARE");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ISWA_DEBUG_RAW_MHA_COMPARE");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ISWA_DEBUG_TURBO_V_FRAME");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ISWA_DEBUG_TURBO_V_FRAME_IDENTITY");
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_ISWA_DEBUG_TURBO_V_FRAME_REVERSE");
            ...
            (void) llama_kvarn_parse_env_flag("LLAMA_KVARN_REQUIRE_DIRECT_RECORD_BATCH_PHASES");
...
llm_graph_result * llama_context::process_ubatch(const llama_ubatch & ubatch, llm_graph_type gtype, llama_memory_context_i * mctx, ggml_status & ret) {
    ...
    // Attribution aid: with LLAMA_KVARN_GRAPH_REUSE_TRACE=1, log whether each
    // ubatch reused a cached graph or paid a full rebuild. tg64 should show
    // reused=1 for every decode token after the first; pp512 with prefill
