...
DECL_FATTN_MMA_TURBO_CASE(128, 128, 4, 4, GGML_TYPE_TQ6_0, GGML_TYPE_TQ6_0);
DECL_FATTN_MMA_TURBO_CASE(128, 128, 4, 4, GGML_TYPE_TQ5_0, GGML_TYPE_TQ5_0);
DECL_FATTN_MMA_TURBO_CASE(128, 128, 4, 4, GGML_TYPE_TQ6_0, GGML_TYPE_TURBO3_0);
DECL_FATTN_MMA_TURBO_CASE(128, 128, 4, 4, GGML_TYPE_TQ5_0, GGML_TYPE_TURBO3_0);
