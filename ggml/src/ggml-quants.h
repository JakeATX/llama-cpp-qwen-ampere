...
GGML_API void quantize_row_q8_cr_ref(const float * GGML_RESTRICT x, block_q8_cr * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q5_cr_ref(const float * GGML_RESTRICT x, block_q5_cr * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q6_cr_ref(const float * GGML_RESTRICT x, block_q6_cr * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_q8_cr(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q5_cr(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_q6_cr(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
...
// TQ5_0: 5-bit TurboQuant KV cache (WHT + 32-level Lloyd-Max PolarQuant)
GGML_API void quantize_row_tq5_0_ref(const float * GGML_RESTRICT x, block_tq5_0 * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_tq5_0(const block_tq5_0 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_tq5_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
