...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TQ6_0   = 51, // TurboQuant 6-bit KV cache: WHT + 6-bit PolarQuant (runtime-only KV type)
        GGML_TYPE_TQ5_0   = 52, // TurboQuant 5-bit KV cache: WHT + 5-bit PolarQuant (runtime-only KV type)
        GGML_TYPE_COUNT   = 53,
    };
