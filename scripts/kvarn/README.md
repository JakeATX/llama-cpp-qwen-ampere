...
- Reusable benchmark matrix harness:
  ...
  `llama_kv_cache_kvarn:` initialization logs, at least one KVarN layer
  allocation line, and a KVarN benchmark row, so benchmark artifacts cannot
  hide a normal-KV fallback.
