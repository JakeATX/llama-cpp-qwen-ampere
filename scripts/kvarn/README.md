...
- Current-build 512 Gemma 4 KVarN+ISWA benchmark on the static CUDA build:
  ...
  `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\kvarn\run_bench_matrix.ps1 -Model "C:\Users\sjake\Downloads\gemma-4-12b-it-UD-Q3_K_XL.gguf" -BuildDir build-kvarn-cuda-static-vs -CaseList "tg16:0:16" -RtnQuantile 0.95 -FlashAttn off -Repetitions 1 -MinKvarnLayerLogs 8`.
  This passed with normal KV `61.26` tok/s, KVarN `49.46` tok/s, and exactly
  8 KVarN layer log lines for Gemma full-attention layers `5, 11, 17, 23, 29,
  35, 41, 47`.
